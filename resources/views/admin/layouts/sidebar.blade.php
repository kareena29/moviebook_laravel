<aside class="main-sidebar sidebar-dark-primary elevation-4 " id="offcanvas">
        ...
        <span class="brand-text font-weight-light" style="color:white; font-size: 25px;font-weight: bold; margin: 10px;">Movie App</span>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open">
                    <ul class="nav nav-treeview">
                        ...
                        <!-- <li class="nav-item">
                            <a href="{{route('screening-details')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p style="color:#1aa67d;font-size: 22px">Screening Details</p>
                            </a>
                        </li> -->
                        <li class="nav-item">
